...
namespace sds
{
	...
	[[nodiscard]]
	constexpr
	auto GetDownVirtualKeycodesRange(const ControllerStateOperations_c auto wrapper) noexcept -> keyboardtypes::SmallVector_t<int>
	{
		constexpr auto settings = wrapper.GetSettings();
		keyboardtypes::SmallVector_t<int> allKeys{};
