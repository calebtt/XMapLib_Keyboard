...
{
	[[nodiscard]]
	constexpr bool IsFloatZero(const auto testFloat) noexcept
	{
	...
	using PolarInfoPair = std::pair<ComputationFloat_t, ComputationFloat_t>;
	 ...
	 */
	[[nodiscard]]
	inline auto ComputePolarPair(const ComputationFloat_t xStickValue, const ComputationFloat_t yStickValue) noexcept -> PolarInfoPair
	{
